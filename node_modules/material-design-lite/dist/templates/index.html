...
<html lang="en">
  <head>
    ...
    <!-- <meta name="msapplication-TileImage" page-content="images/touch/ms-touch-icon-144x144-precomposed.png"> -->
    <!-- <meta name="msapplication-TileColor" page-content="#3372DF"> -->
...
<section class="template template--blog docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  ...
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-blog.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
...
<section class="template template--android-dot-com docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  ...
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-android-dot-com.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">file_download</i>
      </button>
      Download
...
<section class="template template--dashboard docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  ...
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-dashboard.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">file_download</i>
      </button>
      Download
...
<section class="template template--portfolio docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  <img src="../assets/templates/portfolio.jpg"
    srcset="../assets/templates/portfolio.jpg 1x, ../assets/templates/portfolio_2x.jpg 2x"
    class="template__preview mdl-cell mdl-cell--8-col">
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    <h3 class="template__header mdl-cell mdl-cell--12-col mdl-typography--body-2">Portfolio</h3>
    <p class="mdl-cell mdl-cell--12-col">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-portfolio.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">file_download</i>
      </button>
      Download
    </a>
    <a href="../templates/portfolio/index.html" target="_blank" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">arrow_forward</i>
      </button>
      Preview
...
<section class="template template--text-only docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  ...
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-text-only.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">file_download</i>
      </button>
      Download
...
<section class="template template--article docs-text-styling mdl-grid mdl-cell mdl-cell--12-col">
  ...
  <div class="template__meta mdl-cell mdl-cell--4-col mdl-grid mdl-grid--no-spacing">
    ...
    <a href="https://code.getmdl.io/1.1.3/mdl-template-article.zip" class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
        <i class="material-icons">file_download</i>
      </button>
      Download
